...
class Empresa extends Model
{
    ...
    public function attributes()
    {
        return [
            ...
            'emp_nmult' => '"Dados Gerais"Nome multmais',
            ...
            'emp_checkm' => '"Dados Gerais"Check Out multmais',
            ...
            //multmais
            'blt_ctr' => 'Boletagem',
            'tax_blt' => '"multmais"Taxa',
            'emp_cdgbc' => '"multmais"Banco Principal',
            'emp_agbc' => '"multmais"Agência',
            'emp_ccbc' => '"multmais"Conta Corrente',
            'emp_pix' => '"multmais"Chave PIX',
            'emp_seller' => '"multmais"Seller',
            'emp_cdgbcs' => '"multmais"Banco Secundário',
            'emp_agbcs' => '"multmais"Agência',
            'emp_ccbcs' => '"multmais"Conta Corrente',
            'emp_pixs' => '"multmais"Chave PIX',
            'emp_sellers' => '"multmais"Seller',
            ...
            'vlr_pix' => '"multmais"',
            'vlr_boleto' => '"multmais"',
            'vlr_bolepix' => '"multmais"',
            'dias_inat_card' => '"multmais"',
            'isnt_pixblt' => '"multmais"',
            'card_posparc' => '',
    ...
    public function messages()
    {
        return [
            ...
            // 'emp_agbc.required' => ' "multmais" Campo obrigatório .',
            // 'emp_ccbc.required' => ' "multmais" Campo obrigatório.',
            // 'emp_pix.required' => ' "multmais" Campo obrigatório.',
