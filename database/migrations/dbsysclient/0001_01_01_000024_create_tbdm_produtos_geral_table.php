...
class CreateTbdmProdutosGeralTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbdm_produtos_geral', function (Blueprint $table) {
            ...
            //FIELDS
            $table->float('partcp_pvlaor');
            $table->string('partcp_seller', 100);
            $table->string('partcp_pgsplit', 1);
            $table->string('partcp_pgtransf', 1);
            $table->string('partcp_cdgbc', 6);
            $table->string('partcp_agbc', 20);
            $table->string('partcp_ccbc', 20);
            $table->string('partcp_pix', 100);
            $table->string('produto_ncm', 10);
            $table->string('produto_cdgb', 255);
            $table->decimal('produto_peso', 10, 2);
            $table->string('produto_ctrl', 1);
            $table->string('produto_dc', 15);
