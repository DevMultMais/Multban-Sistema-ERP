...
<section class="content">
    <form class="form-horizontal" id="formPrincipal" role="form" method="POST" action="{{ route('usuario.update', $usuario->user_id) }}">
        @method('PATCH')
        @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="number" disabled name="id" value="{{$usuario->user_id ?? ''}}" placeholder="0" disabled class="form-control  form-control-sm">
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-4">
                                <img id="image-product" class="img-circle elevation-2 m-3" src="{{empty($usuario->image) ? url('/assets/image/') . '/' . 'no-product-image.png' : url('/storage/images/usuario') . '/' . $usuario->image}}" alt="{{$usuario->image}}" style="
                                border-radius: 50%;
                                position: relative;
                                height: 117px;
                                width: 117px;
