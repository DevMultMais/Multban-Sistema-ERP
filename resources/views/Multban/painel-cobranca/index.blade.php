                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary mt-1" title="Desdobrar a parcela">
                                            <i class="fas fa-share-all"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-primary mt-1" title="Isentar multa e juros">
                                            <i class="fas fa-virus-slash"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-primary mt-1" title="Negociação Multa e Juros">
                                            <i class="fas fa-hand-holding-usd"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-primary mt-1" title="Reparcelar Título">
                                            <i class="fas fa-sitemap"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-primary mt-1" title="Enviar Cobrança">
                                            <i class="fas fa-paper-plane"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-primary mt-1" title="Atendimento">
