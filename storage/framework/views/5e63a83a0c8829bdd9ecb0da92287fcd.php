...
<section class="content">
    <?php if($routeAction): ?>
        <form class="form-horizontal" id="formPrincipal" role="form" method="POST"
            action="<?php echo e(route('empresa.update', $empresaGeral->emp_id)); ?>">
            <?php echo method_field('PATCH'); ?>
    <?php else: ?>
            <form class="form-horizontal" id="formPrincipal" role="form" method="POST"
                action="<?php echo e(route('empresa.store')); ?>">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="dados-gerais" role="tabpanel"
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input autocomplete="off" type="text" autofocus="autofocus"
                                            ...
                                            value="<?php echo e(str_pad($empresaGeral->emp_id, 5, "0", STR_PAD_LEFT)); ?>"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" <?php echo e($empresaGeral->emp_wl == 'x' ? 'checked' : ''); ?> type="checkbox" name="emp_wl" id="emp_wl">
                                ...
                                <div class="form-group col-md-2">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" <?php echo e($empresaGeral->emp_privlbl == 'x' ? 'checked' : ''); ?> type="checkbox" name="emp_privlbl" id="emp_privlbl">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" type="text" autofocus="autofocus"
                                        ...
                                        value="<?php echo e($empresaGeral->emp_cnpj); ?>" required placeholder="00.000.000.0000/00">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-control select2" name="emp_sts" id="emp_sts"
                                        ...
                                        <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <option <?php echo e($sta->emp_sts == $empresaGeral->emp_sts ? 'selected' : ''); ?>

                                                value="<?php echo e($sta->emp_sts); ?>"><?php echo e($sta->emp_sts_desc); ?></option>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" class="form-control" placeholder="White Label da Empresa"
                                        ...
                                        value="<?php echo e($empresaGeral->emp_wlde); ?>" readonly>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control ie" id="emp_ie"
                                        name="emp_ie" value="<?php echo e($empresaGeral->emp_ie); ?>"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control" id="emp_im" name="emp_im"
                                        value="<?php echo e($empresaGeral->emp_im); ?>" placeholder="Inscrição Municipal">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" type="text" maxlength="255" class="form-control"
                                        id="emp_rzsoc" name="emp_rzsoc" value="<?php echo e($empresaGeral->emp_rzsoc); ?>"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" maxlength="255" type="text" class="form-control"
                                        id="emp_nfant" name="emp_nfant" value="<?php echo e($empresaGeral->emp_nfant); ?>"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" maxlength="15" type="text" class="form-control"
                                        id="emp_nmult" name="emp_nmult" value="<?php echo e($empresaGeral->emp_nmult); ?>"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="emp_ratv" name="emp_ratv"
                                        ...
                                        <option></option>
                                        <?php $__currentLoopData = $ratvs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ramo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <option <?php echo e($ramo->emp_ratv == $empresaGeral->emp_ratv ? 'selected' : ''); ?>

                                                value="<?php echo e($ramo->emp_ratv); ?>"><?php echo e($ramo->emp_ratv_desc); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio"
                                                <?php echo e($empresaGeral->emp_frq == 'x' ? 'checked' : ''); ?> value="sim"
                                                id="emp_frq" name="emp_frq">
                                            <label for="emp_frq" class="custom-control-label">SIM</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" <?php echo e($empresaGeral->emp_frq == '' ? 'checked' : ''); ?> value="nao" type="radio" id="emp_frq_n" name="emp_frq">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control select2" data-allow-clear="true"
                                        <?php if($empresaGeral->emp_frq == 'x'): ?> disabled="disabled" <?php endif; ?> name="emp_frqmst"
                                        id="emp_frqmst" data-placeholder="Selecione" style="width: 100%;">
                                        <option></option>
                                        <?php $__currentLoopData = $franqueadorMaster; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $master): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <option <?php echo e($master->emp_id == $empresaGeral->emp_frqmst ? 'selected' : ''); ?>

                                                value="<?php echo e($master->emp_id); ?>"><?php echo e($master->emp_rzsoc); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio"
                                                <?php echo e($empresaGeral->emp_frqcmp == 'x' ? 'checked' : ''); ?> value="sim"
                                                id="emp_frqcmp" name="emp_frqcmp">
                                            <label for="emp_frqcmp" class="custom-control-label">SIM</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio"
                                                <?php echo e($empresaGeral->emp_frqcmp == '' ? 'checked' : ''); ?> value="nao"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio"
                                                <?php echo e($empresaGeral->emp_altlmt == 'x' ? 'checked' : ''); ?> value="sim"
                                                id="emp_altlmt" name="emp_altlmt">
                                            <label for="emp_altlmt" class="custom-control-label">SOMENTE GESTOR</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio"
                                                <?php echo e($empresaGeral->emp_altlmt == '' ? 'checked' : ''); ?> value="nao"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" <?php echo e($empresaGeral->emp_integra == 'x' ? 'checked' : ''); ?> type="checkbox" name="emp_integra" id="emp_integra">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" <?php echo e($empresaGeral->emp_checkb == 'x' ? 'checked' : ''); ?> type="checkbox" name="emp_checkb" id="emp_checkb">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" <?php echo e($empresaGeral->emp_checkm == 'x' ? 'checked' : ''); ?> type="checkbox" name="emp_checkm" id="emp_checkm">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" <?php echo e($empresaGeral->emp_checkc == 'x' ? 'checked' : ''); ?> type="checkbox" name="emp_checkc" id="emp_checkc">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" <?php echo e($empresaGeral->emp_reemb == 'x' ? 'checked' : ''); ?> type="checkbox" name="emp_reemb" id="emp_reemb">
                                ...
                                <div class="form-group col-md-3">
                                    <select class="form-control select2" name="emp_tpbolet" data-allow-clear="true"
                                        ...
                                        <option></option>
                                        <?php $__currentLoopData = $tipoDeBoletagem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tpbolet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <option <?php echo e($tpbolet->emp_tpbolet == $empresaGeral->emp_tpbolet ? 'selected' : ''); ?>

                                                value="<?php echo e($tpbolet->emp_tpbolet); ?>"><?php echo e($tpbolet->tpbolet_desc); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                ...
                                <div class="form-group col-md-3">
                                    <select class="form-control select2" name="tp_plano" data-allow-clear="true"
                                        ...
                                        <option></option>
                                        <?php $__currentLoopData = $tiposDePlanoVendido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tpplano): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <option <?php echo e($tpplano->tp_plano == $empresaGeral->tp_plano ? 'selected' : ''); ?>

                                                value="<?php echo e($tpplano->tp_plano); ?>"><?php echo e($tpplano->tp_plano_desc); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                ...
                                <div class="form-group col-md-3">
                                    <select class="form-control select2" data-allow-clear="true" name="emp_adqrnt"
                                        ...
                                        <option></option>
                                        <?php $__currentLoopData = $tipoDeAdquirentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tpadqrnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <option <?php echo e($tpadqrnt->emp_adqrnt == $empresaGeral->emp_adqrnt ? 'selected' : ''); ?>

                                                value="<?php echo e($tpadqrnt->emp_adqrnt); ?>"><?php echo e($tpadqrnt->adqrnt_desc); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-control select2" name="emp_meiocom" id="emp_meiocom"
                                        data-placeholder="Selecione" style="width: 100%;">
                                        <option></option>
                                        <?php $__currentLoopData = $meioComomunicacao; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meiocom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <option <?php echo e($meiocom->emp_meiocom == $empresaGeral->emp_meiocom ? 'selected' : ''); ?>

                                                value="<?php echo e($meiocom->emp_meiocom); ?>"><?php echo e($meiocom->meio_com_desc); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control money" id="vlr_imp"
                                        name="vlr_imp" value="<?php echo e($empresaGeral->vlr_imp); ?>" placeholder="0,00">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control datetimepicker-input"
                                        id="dtvenc_imp" name="dtvenc_imp" value="<?php echo e($empresaGeral->dtvenc_imp); ?>"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" type="number" class="form-control" id="cond_pgto"
                                        name="cond_pgto" value="<?php echo e($empresaGeral->cond_pgto); ?>" placeholder="0">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control money" id="vlr_mens"
                                        name="vlr_mens" value="<?php echo e($empresaGeral->vlr_mens); ?>" placeholder="0,00">
                                    <span id="vlr_mensError" class="text-danger text-sm"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="dtvenc_mens">Data de Vencimento da Mensalidade:*</label>
                                    <input autocomplete="off" type="text" class="form-control datetimepicker-input"
                                        id="dtvenc_mens" name="dtvenc_mens" value="<?php echo e($empresaGeral->dtvenc_mens); ?>"
                        ...
                        <div class="tab-pane fade" id="endereco" role="tabpanel" aria-labelledby="endereco-tab">
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="input-group mb-3">
                                        <input autocomplete="off" type="text" autofocus="autofocus"
                                            ...
                                            value="<?php echo e($empresaGeral->emp_cep); ?>" placeholder="00000-000">
                                        <span class="input-group-append">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id='emp_end' name='emp_end' value="<?php echo e($empresaGeral->emp_end); ?>"
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" id='emp_endnum' name='emp_endnum'
                                        value="<?php echo e($empresaGeral->emp_endnum); ?>" class='form-control' placeholder='Número'>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id='emp_endcmp' name='emp_endcmp'
                                        value="<?php echo e($empresaGeral->emp_endcmp); ?>" class='form-control'
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_endbair' name='emp_endbair'
                                        value="<?php echo e($empresaGeral->emp_endbair); ?>" class='form-control'
                                        placeholder='Bairro'>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="emp_endpais" name="emp_endpais"
                                        ...
                                        <?php if($empresaGeral->pais): ?>
                                            <option value="<?php echo e($empresaGeral->pais->pais); ?>"><?php echo e($empresaGeral->pais->pais); ?> -
                                                <?php echo e($empresaGeral->pais->pais_desc); ?></option>
                                        <?php else: ?>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="emp_endest" name="emp_endest"
                                        ...
                                        <?php if($empresaGeral->estado): ?>
                                            <option value="<?php echo e($empresaGeral->estado->estado); ?>">
                                                <?php echo e($empresaGeral->estado->estado); ?> - <?php echo e($empresaGeral->estado->estado_desc); ?>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="emp_endcid" name="emp_endcid"
                                        ...
                                        <?php if($empresaGeral->cidade): ?>
                                            <option value="<?php echo e($empresaGeral->cidade->cidade); ?>">
                                                <?php echo e($empresaGeral->cidade->cidade_ibge); ?>

                                                - <?php echo e($empresaGeral->cidade->cidade_desc); ?></option>
                                        <?php endif; ?>
                                    </select>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_resplg' name='emp_resplg'
                                        value="<?php echo e($empresaGeral->emp_resplg); ?>" class='form-control'
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="email" id='emp_emailrp' name='emp_emailrp'
                                        value="<?php echo e($empresaGeral->emp_emailrp); ?>" class='form-control'
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_celrp' name='emp_celrp'
                                        value="<?php echo e($empresaGeral->emp_celrp); ?>" class='form-control cell_with_ddd'
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_respcm' name='emp_respcm'
                                        value="<?php echo e($empresaGeral->emp_respcm); ?>" class='form-control'
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="email" id='emp_emailcm' name='emp_emailcm'
                                        value="<?php echo e($empresaGeral->emp_emailcm); ?>" class='form-control'
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_celcm' name='emp_celcm'
                                        value="<?php echo e($empresaGeral->emp_celcm); ?>" class='form-control cell_with_ddd'
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_respfi' name='emp_respfi'
                                        value="<?php echo e($empresaGeral->emp_respfi); ?>" class='form-control'
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="email" id='emp_emailfi' name='emp_emailfi'
                                        value="<?php echo e($empresaGeral->emp_emailfi); ?>" class='form-control'
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_celfi' name='emp_celfi'
                                        value="<?php echo e($empresaGeral->emp_celfi); ?>" class='form-control cell_with_ddd'
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_pagweb' name='emp_pagweb'
                                        value="<?php echo e($empresaGeral->emp_pagweb); ?>" class='form-control'
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id='emp_rdsoc' name='emp_rdsoc'
                                        value="<?php echo e($empresaGeral->emp_rdsoc); ?>" class='form-control'
                        ...
                        <div class="tab-pane fade" id="multmais" role="tabpanel" aria-labelledby="multmais-tab">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control select2" data-allow-clear="true"
                                                ...
                                                style="width: 100%;">
                                                <option></option>
                                                <?php $__currentLoopData = $destinoDosValores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e($dest->destvlr == $empresaParam->emp_destvlr ? 'selected' : ''); ?>

                                                        value="<?php echo e($dest->destvlr); ?>"><?php echo e($dest->destvlr); ?> -
                                                        <?php echo e($dest->destvlr_desc); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control select2" data-allow-clear="true"
                                                ...
                                                <?php $__currentLoopData = $codigoDosbancos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $emp_cdgbc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                    <option <?php echo e($emp_cdgbc->cdgbc == $empresaParam->emp_cdgbc ? 'selected' : ''); ?> value="<?php echo e($emp_cdgbc->cdgbc); ?>"><?php echo e($emp_cdgbc->cdgbc); ?> -
                                                        <?php echo e($emp_cdgbc->cdgbc_desc); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <span id="emp_cdgbcError" class="text-danger text-sm"></span>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" maxlength="20" id='emp_agbc' name='emp_agbc'
                                                        value="<?php echo e($empresaParam->emp_agbc); ?>" class='form-control'
                                                        placeholder='Agência'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='emp_ccbc' name='emp_ccbc'
                                                        value="<?php echo e($empresaParam->emp_ccbc); ?>" class='form-control'
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='emp_pix' name='emp_pix'
                                                        value="<?php echo e($empresaParam->emp_pix); ?>" class='form-control'
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='emp_seller' name='emp_seller'
                                                        value="<?php echo e($empresaParam->emp_seller); ?>" class='form-control'
                                                        placeholder='Seller'>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control select2" data-allow-clear="true"
                                                ...
                                                style="width: 100%;">
                                                <option></option>
                                                <?php $__currentLoopData = $codigoDosbancos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $emp_cdgbcs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                    <option <?php echo e($emp_cdgbcs->cdgbc == $empresaParam->emp_cdgbcs ? 'selected' : ''); ?> value="<?php echo e($emp_cdgbcs->cdgbc); ?>"><?php echo e($emp_cdgbcs->cdgbc); ?> -
                                                        <?php echo e($emp_cdgbcs->cdgbc_desc); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" maxlength="20" id='emp_agbcs' name='emp_agbcs'
                                                        value="<?php echo e($empresaParam->emp_agbcs); ?>" class='form-control'
                                                        placeholder='Agência'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='emp_ccbcs' name='emp_ccbcs'
                                                        value="<?php echo e($empresaParam->emp_ccbcs); ?>" class='form-control'
                                                        placeholder='Conta Corrente'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='emp_pixs' name='emp_pixs'
                                                        value="<?php echo e($empresaParam->emp_pixs); ?>" class='form-control'
                                                        placeholder='Chave PIX'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='emp_sellers' name='emp_sellers'
                                                        value="<?php echo e($empresaParam->emp_sellers); ?>" class='form-control'
                                                        placeholder='Seller'>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" id='vlr_pix' name='vlr_pix'
                                                        value="<?php echo e($empresaParam->vlr_pix); ?>" class='form-control money'
                                                        placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" id='vlr_boleto' name='vlr_boleto'
                                                        value="<?php echo e($empresaParam->vlr_boleto); ?>" class='form-control money'
                                                        placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" id='vlr_bolepix' name='vlr_bolepix'
                                                        value="<?php echo e($empresaParam->vlr_bolepix); ?>"
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='dias_inat_card' name='dias_inat_card'
                                                        value="<?php echo e($empresaParam->dias_inat_card); ?>" class='form-control'
                                                        placeholder='0'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='isnt_pixblt' name='isnt_pixblt'
                                                        value="<?php echo e($empresaParam->isnt_pixblt); ?>"
                                                        class='form-control money' placeholder='0,00'>
                                    ...
                                    <div
                                        class="card card-outline card-primary <?php echo e($empresaParam->blt_ctr == 'x' ? '' : 'collapsed-card'); ?>">
                                        <div class="card-header">
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" <?php echo e($empresaParam->blt_ctr == 'x' ? 'checked' : ''); ?> type="checkbox" name="blt_ctr" id="blt_ctr">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" id='tax_blt' name='tax_blt'
                                                        value="<?php echo e($empresaParam->tax_blt); ?>"
                                    ...
                                    <div
                                        class="card card-outline card-primary <?php echo e($empresaParam->lib_cnscore == 'x' ? '' : 'collapsed-card'); ?>">
                                        <div class="card-header">
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->lib_cnscore == 'x' ? 'checked' : ''); ?>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='intervalo_mes' name='intervalo_mes'
                                                        value="<?php echo e($empresaParam->intervalo_mes); ?>" class='form-control'
                                                        placeholder='0'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='qtde_cns_freem' name='qtde_cns_freem'
                                                        value="<?php echo e($empresaParam->qtde_cns_freem); ?>" class='form-control'
                                                        placeholder='0'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='qtde_cns_cntrm' name='qtde_cns_cntrm'
                                                        value="<?php echo e($empresaParam->qtde_cns_cntrm); ?>" class='form-control'
                                                        placeholder='0'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='qtde_cns_prem' readonly disabled='disabled'
                                                        name='qtde_cns_prem' value="<?php echo e($empresaParam->qtde_cns_prem); ?>"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='qtde_cns_totm' name='qtde_cns_totm'
                                                        ...
                                                        value="<?php echo e($empresaParam->qtde_cns_totm); ?>" class='form-control'
                                                        placeholder='0'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='qtde_cns_utlxm' name='qtde_cns_utlxm'
                                                        readonly disabled='disabled'
                                                        value="<?php echo e($empresaParam->qtde_cns_utlxm); ?>" class='form-control'
                                                        placeholder='0'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='qtde_cns_dispm' name='qtde_cns_dispm'
                                                        readonly disabled='disabled'
                                                        value="<?php echo e($empresaParam->qtde_cns_dispm); ?>" class='form-control'
                                                        placeholder='0'>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div
                                        class="card card-outline card-primary <?php echo e($empresaParam->card_posctr == 'x' ? '' : 'collapsed-card'); ?>">
                                        <div class="card-header">
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->card_posctr == 'x' ? 'checked' : ''); ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="number" id='card_posparc' name='card_posparc'
                                                        value="<?php echo e($empresaParam->card_posparc); ?>" class='form-control'
                                                        placeholder='0'>
                                            ...
                                            <div class="card card-prinary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    ?>
                                                    <div id="taxa_avista">
                                                        <?php $__currentLoopData = $empresaTaxpos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($tax->tax_categ == "VISTA"): ?>
                                                                <div class="form-row" id="taxa_avista_<?php echo e($countTax); ?>">
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm"
                                                                            value="<?php echo e($tax->tax_categ); ?>"
                                                                            name="tax_categ_avista[<?php echo e($countTax); ?>][categ]"
                                                                            type="hidden">
                                                                        <input class="form-control form-control-sm"
                                                                            data-categ="<?php echo e($tax->tax_categ); ?>"
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_parc_de"
                                                                            value="<?php echo e($tax->parc_de); ?>" placeholder="0"
                                                                            name="tax_categ_avista[<?php echo e($countTax); ?>][parc_de]"
                                                                            type="number">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm"
                                                                            data-categ="<?php echo e($tax->tax_categ); ?>"
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_parc_ate"
                                                                            value="<?php echo e($tax->parc_ate); ?>" placeholder="0"
                                                                            name="tax_categ_avista[<?php echo e($countTax); ?>][parc_ate]"
                                                                            type="number">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm porcentagem"
                                                                            data-categ="<?php echo e($tax->tax_categ); ?>"
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_taxa"
                                                                            value="<?php echo e($tax->tax); ?>" placeholder="0,00"
                                                                            name="tax_categ_avista[<?php echo e($countTax); ?>][taxa]"
                                                                            type="text">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <button type="button" data-id="<?php echo e($countTax); ?>"
                                                                            data-categ="avista"
                                            ...
                                            <div class="card card-prinary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div id="taxa_30">
                                                        <?php $__currentLoopData = $empresaTaxpos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($tax->tax_categ == "PRM_30"): ?>
                                                                <div class="form-row" id="taxa_30_<?php echo e($countTax); ?>">
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm"
                                                                            value="<?php echo e($tax->tax_categ); ?>"
                                                                            name="tax_categ_30[<?php echo e($countTax); ?>][categ]"
                                                                            type="hidden">
                                                                        <input class="form-control form-control-sm"
                                                                            data-categ="<?php echo e($tax->tax_categ); ?>"
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_parc_de"
                                                                            value="<?php echo e($tax->parc_de); ?>" placeholder="0"
                                                                            name="tax_categ_30[<?php echo e($countTax); ?>][parc_de]"
                                                                            type="number">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm"
                                                                            ...
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_parc_ate"
                                                                            value="<?php echo e($tax->parc_ate); ?>" placeholder="0"
                                                                            name="tax_categ_30[<?php echo e($countTax); ?>][parc_ate]"
                                                                            type="number">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm porcentagem"
                                                                            ...
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_taxa"
                                                                            value="<?php echo e($tax->tax); ?>" placeholder="0,00"
                                                                            name="tax_categ_30[<?php echo e($countTax); ?>][taxa]"
                                                                            type="text">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <button type="button" data-id="<?php echo e($countTax); ?>"
                                            ...
                                            <div class="card card-prinary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div id="taxa_60">
                                                        <?php $__currentLoopData = $empresaTaxpos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($tax->tax_categ == "PRM_60"): ?>
                                                                <div class="form-row" id="taxa_60_<?php echo e($countTax); ?>">
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm"
                                                                            value="<?php echo e($tax->tax_categ); ?>"
                                                                            name="tax_categ_60[<?php echo e($countTax); ?>][categ]"
                                                                            type="hidden">
                                                                        <input class="form-control form-control-sm"
                                                                            data-categ="<?php echo e($tax->tax_categ); ?>"
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_parc_de"
                                                                            value="<?php echo e($tax->parc_de); ?>" placeholder="0"
                                                                            name="tax_categ_60[<?php echo e($countTax); ?>][parc_de]"
                                                                            type="number">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm"
                                                                            ...
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_parc_ate"
                                                                            value="<?php echo e($tax->parc_ate); ?>" placeholder="0"
                                                                            name="tax_categ_60[<?php echo e($countTax); ?>][parc_ate]"
                                                                            type="number">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm porcentagem"
                                                                            ...
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_taxa"
                                                                            value="<?php echo e($tax->tax); ?>" placeholder="0,00"
                                                                            name="tax_categ_60[<?php echo e($countTax); ?>][taxa]"
                                                                            type="text">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <button type="button" data-id="<?php echo e($countTax); ?>"
                                            ...
                                            <div class="card card-prinary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div id="taxa_90">
                                                        <?php $__currentLoopData = $empresaTaxpos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($tax->tax_categ == "PRM_90"): ?>
                                                                <div class="form-row" id="taxa_90_<?php echo e($countTax); ?>">
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm"
                                                                            value="<?php echo e($tax->tax_categ); ?>"
                                                                            name="tax_categ_90[<?php echo e($countTax); ?>][categ]"
                                                                            type="hidden">
                                                                        <input class="form-control form-control-sm"
                                                                            data-categ="<?php echo e($tax->tax_categ); ?>"
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_parc_de"
                                                                            value="<?php echo e($tax->parc_de); ?>" placeholder="0"
                                                                            name="tax_categ_90[<?php echo e($countTax); ?>][parc_de]"
                                                                            type="number">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm"
                                                                            ...
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_parc_ate"
                                                                            value="<?php echo e($tax->parc_ate); ?>" placeholder="0"
                                                                            name="tax_categ_90[<?php echo e($countTax); ?>][parc_ate]"
                                                                            type="number">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <input class="form-control form-control-sm porcentagem"
                                                                            ...
                                                                            data-tipo="<?php echo e($tax->tax_categ); ?>_taxa"
                                                                            value="<?php echo e($tax->tax); ?>" placeholder="0,00"
                                                                            name="tax_categ_90[<?php echo e($countTax); ?>][taxa]"
                                                                            type="text">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <button type="button" data-id="<?php echo e($countTax); ?>"
                                    ...
                                    <div
                                        class="card card-outline card-primary <?php echo e($empresaParam->cob_mltjr_atr == 'x' ? '' : 'collapsed-card'); ?>">
                                        <div class="card-header">
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->cob_mltjr_atr == 'x' ? 'checked' : ''); ?>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='perc_mlt_atr' name='perc_mlt_atr'
                                                        value="<?php echo e($empresaParam->perc_mlt_atr); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='perc_jrs_atr' name='perc_jrs_atr'
                                                        value="<?php echo e($empresaParam->perc_jrs_atr); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='perc_com_mltjr' name='perc_com_mltjr'
                                                        value="<?php echo e($empresaParam->perc_com_mltjr); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div
                                        class="card card-outline card-primary <?php echo e($empresaParam->parc_cjuros == 'x' ? '' : 'collapsed-card'); ?>">
                                        <div class="card-header">
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->parc_cjuros == 'x' ? 'checked' : ''); ?>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="number" id='parc_jr_deprc' name='parc_jr_deprc'
                                                        value="<?php echo e($empresaParam->parc_jr_deprc); ?>" class='form-control'
                                                        placeholder='0'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='tax_jrsparc' name='tax_jrsparc'
                                                        value="<?php echo e($empresaParam->tax_jrsparc); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='parc_com_jrs' name='parc_com_jrs'
                                                        value="<?php echo e($empresaParam->parc_com_jrs); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card card-outline card-primary <?php echo e($empresaParam->card_prectr == 'x' ? '' : 'collapsed-card'); ?> "
                                        id="card_prectr_coll">
                                        <div class="card-header">
                                            ...
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->card_prectr == 'x' ? 'checked' : ''); ?>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='tax_pre' name='tax_pre'
                                                        value="<?php echo e($empresaParam->tax_pre); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-outline card-primary <?php echo e($empresaParam->card_giftctr == 'x' ? '' : 'collapsed-card'); ?>"
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->card_giftctr == 'x' ? 'checked' : ''); ?>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='tax_gift' name='tax_gift'
                                                        value="<?php echo e($empresaParam->tax_gift); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-outline card-primary <?php echo e($empresaParam->card_fidctr == 'x' ? '' : 'collapsed-card'); ?>"
                                        id="card_fidctr_coll">
                                        <div class="card-header">
                                            ...
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->card_fidctr == 'x' ? 'checked' : ''); ?>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='tax_fid' name='tax_fid'
                                                        value="<?php echo e($empresaParam->tax_fid); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input"
                                                            <?php echo e($empresaParam->pp_particular == 'x' ? 'checked' : ''); ?>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input"
                                                            <?php echo e($empresaParam->pp_franquia == 'x' ? 'checked' : ''); ?>
                                                ...
                                                <div class="form-group col-md-3">
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input"
                                                            <?php echo e($empresaParam->pp_multmais == 'x' ? 'checked' : ''); ?>
                                                ...
                                                <div class="form-group col-md-3">
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input"
                                                            <?php echo e($empresaParam->pp_cashback == 'x' ? 'checked' : ''); ?>
                        ...
                        <div class="tab-pane fade" id="antecipacao" role="tabpanel" aria-labelledby="antecipacao-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div
                                        class="card card-outline card-primary <?php echo e($empresaParam->antecip_ctr == 'x' ? '' : 'collapsed-card'); ?>">
                                        <div class="card-header">
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->antecip_ctr == 'x' ? 'checked' : ''); ?>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='tax_antmult' name='tax_antmult'
                                                        value="<?php echo e($empresaParam->tax_antmult); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='tax_antfundo' name='tax_antfundo'
                                                        value="<?php echo e($empresaParam->tax_antfundo); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id='perc_rec_ant' name='perc_rec_ant'
                                                        value="<?php echo e($empresaParam->perc_rec_ant); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-radio">
                                                            <input class="custom-control-input"
                                                                <?php echo e($empresaParam->inad_descprox == 'x' ? 'checked' : ''); ?>
                                                        ...
                                                        <div class="custom-control custom-radio">
                                                            <input class="custom-control-input"
                                                                <?php echo e($empresaParam->inad_semrisco == 'x' ? 'checked' : ''); ?>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-control select2" data-allow-clear="true"
                                                                ...
                                                                <?php $__currentLoopData = $codigoDosbancos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $emp_cdgbcs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <option
                                                                        <?php echo e($emp_cdgbcs->cdgbc == $empresaParam->fndant_cdgbc ? 'selected' : ''); ?> value="<?php echo e($emp_cdgbcs->cdgbc); ?>">
                                                                        <?php echo e($emp_cdgbcs->cdgbc); ?> - <?php echo e($emp_cdgbcs->cdgbc_desc); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <input type="text" maxlength="20" id='fndant_agbc'
                                                                        name='fndant_agbc'
                                                                        value="<?php echo e($empresaParam->fndant_agbc); ?>"
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <input type="text" id='fndant_ccbc'
                                                                        name='fndant_ccbc'
                                                                        value="<?php echo e($empresaParam->fndant_ccbc); ?>"
                                                                        class='form-control'
                                                                        placeholder='Conta Corrente'>
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <input type="text" id='fndant_pix' name='fndant_pix'
                                                                        value="<?php echo e($empresaParam->fndant_pix); ?>"
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <input type="text" id='fndant_seller'
                                                                        name='fndant_seller'
                                                                        value="<?php echo e($empresaParam->fndant_seller); ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div
                                        class="card card-outline card-primary <?php echo e($empresaParam->antecip_auto == 'x' ? '' : 'collapsed-card'); ?>">
                                        <div class="card-header">
                                            <div class="card-title pt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input"
                                                        <?php echo e($empresaParam->antecip_auto == 'x' ? 'checked' : ''); ?>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="number" id='ant_auto_srvd'
                                                                        name='ant_auto_srvd'
                                                                        value="<?php echo e($empresaParam->ant_auto_srvd); ?>"
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="number" id='ant_auto_prdvo'
                                                                        name='ant_auto_prdvo'
                                                                        value="<?php echo e($empresaParam->ant_auto_prdvo); ?>"
                                                                        class='form-control col-md-4' placeholder='0'>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="number" id='ant_auto_prdvd'
                                                                        name='ant_auto_prdvd'
                                                                        value="<?php echo e($empresaParam->ant_auto_prdvd); ?>"
                                                                        class='form-control col-md-4' placeholder='0'>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <div class="custom-control custom-checkbox ml-4 p-3">
                                        <input class="custom-control-input" <?php echo e($empresaParam->ant_blktit == 'x' ? 'checked' : ''); ?> type="checkbox" name="ant_blktit" id="ant_blktit">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="custom-control custom-checkbox p-3">
                                        <input class="custom-control-input" <?php echo e($empresaParam->ant_titpdv == 'x' ? 'checked' : ''); ?> type="checkbox" name="ant_titpdv" id="ant_titpdv">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select class="form-control select2" data-allow-clear="true"
                                                        ...
                                                        aria-hidden="true">
                                                        <?php if($rebateLoja): ?>
                                                            <option value="<?php echo e($rebateLoja->emp_id); ?>"><?php echo e($rebateLoja->emp_id); ?>

                                                                - <?php echo e($rebateLoja->emp_rzsoc); ?></option>
                                                        <?php endif; ?>
                                                    </select>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" id='tax_rebate' name='tax_rebate'
                                                        value="<?php echo e($empresaParam->tax_rebate); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-radio">
                                                            <input class="custom-control-input"
                                                                <?php echo e($empresaParam->rebate_split == 'x' ? 'checked' : ''); ?>
                                                        ...
                                                        <div class="custom-control custom-radio">
                                                            <input class="custom-control-input"
                                                                <?php echo e($empresaParam->rebate_transf == 'x' ? 'checked' : ''); ?>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select class="form-control select2" data-allow-clear="true"
                                                        ...
                                                        data-placeholder="Pesquise a Empresa" style="width: 100%;"
                                                        aria-hidden="true">
                                                        <?php if($royaltiesLoja): ?>
                                                            <option value="<?php echo e($royaltiesLoja->emp_id); ?>">
                                                                <?php echo e($royaltiesLoja->emp_id); ?> - <?php echo e($royaltiesLoja->emp_rzsoc); ?>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" id='tax_royalties' name='tax_royalties'
                                                        value="<?php echo e($empresaParam->tax_royalties); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-radio">
                                                            <input class="custom-control-input"
                                                                <?php echo e($empresaParam->royalties_split == 'x' ? 'checked' : ''); ?>
                                                        ...
                                                        <div class="custom-control custom-radio">
                                                            <input class="custom-control-input"
                                                                <?php echo e($empresaParam->royalties_transf == 'x' ? 'checked' : ''); ?> type="radio" id="royalties_transf"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select class="form-control select2" data-allow-clear="true"
                                                        ...
                                                        aria-hidden="true">
                                                        <?php if($comissaoLoja): ?>
                                                            <option value="<?php echo e($comissaoLoja->emp_id); ?>">
                                                                <?php echo e($comissaoLoja->emp_id); ?> - <?php echo e($comissaoLoja->emp_rzsoc); ?>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" id='tax_comiss' name='tax_comiss'
                                                        value="<?php echo e($empresaParam->tax_comiss); ?>"
                                                        class='form-control porcentagem' placeholder='0,00'>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-radio">
                                                            <input class="custom-control-input"
                                                                <?php echo e($empresaParam->comiss_split == 'x' ? 'checked' : ''); ?>
                        ...
                        <div class="tab-pane fade" id="cobrancas" role="tabpanel" aria-labelledby="cobrancas-tab">
                            ...
                            <div
                                class="card card-outline card-primary <?php echo e($empresaParam->cobsrv_atv == 'x' ? '' : 'collapsed-card'); ?>">
                                <div class="card-header">
                                    <div class="card-title pt-2">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" <?php echo e($empresaParam->cobsrv_atv == 'x' ? 'checked' : ''); ?> type="checkbox" name="cobsrv_atv" id="cobsrv_atv">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" id='cobsrv_diasatr' name='cobsrv_diasatr'
                                                value="<?php echo e($empresaParam->cobsrv_diasatr); ?>" class='form-control'
                                                placeholder='0'>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id='cobsrv_multa' name='cobsrv_multa'
                                                value="<?php echo e($empresaParam->cobsrv_multa); ?>" class='form-control porcentagem'
                                                placeholder='0,00'>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id='cobsrv_juros' name='cobsrv_juros'
                                                value="<?php echo e($empresaParam->cobsrv_juros); ?>" class='form-control porcentagem'
                                                placeholder='0,00'>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id='tax_cobsrv_adm' name='tax_cobsrv_adm'
                                                value="<?php echo e($empresaParam->tax_cobsrv_adm); ?>"
                                                class='form-control porcentagem' placeholder='0,00'>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id='tax_cobsrv_juss' name='tax_cobsrv_juss'
                                                value="<?php echo e($empresaParam->tax_cobsrv_juss); ?>"
                                                class='form-control porcentagem' placeholder='0,00'>
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            setTimeout(() => {
                listaTaxa = <?php echo e($empresaTaxpos->count() + 2); ?>;

            }, 1000);


            <?php if($empresaParam->emp_cdgbc): ?>
                $("#banco-principal").show();
            <?php endif; ?>

            <?php if($empresaParam->emp_cdgbcs): ?>
                $("#banco-secundario").show();
            <?php endif; ?>

            <?php if($empresaParam->fndant_cdgbc): ?>
                $("#banco-fndant").show();
            <?php endif; ?>

            <?php if($empresaGeral->emp_checkb != "x"): ?>
                $("#emp_tpbolet").prop("disabled", true);
            <?php endif; ?>

            <?php if($empresaGeral->emp_checkm != "x"): ?>
                $("#tp_plano").prop("disabled", true);

            <?php endif; ?>

            <?php if($empresaGeral->emp_checkc != "x"): ?>
    ...
    <!-- Moment -->
    <script src="<?php echo e(asset('assets/plugins/moment/moment-with-locales.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/dist/js/pages/empresa/empresa.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Marcio Bomfim\Desktop\novo\system\multban\resources\views/Multban/empresa/edit.blade.php ENDPATH**/ ?>