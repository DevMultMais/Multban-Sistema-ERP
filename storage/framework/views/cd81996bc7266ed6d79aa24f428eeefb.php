...
<?php $__env->startSection('page.title', 'PDV - Venda'); ?>
...
<section class="content">
    <div class="container-fluid">
        <input id="idempresa" name="idempresa" value="<?php echo e(auth()->user()->idempresafilial); ?>" type="hidden" />
        <input id="orcamento" name="orcamento" value="0" type="hidden" />
        <input id="pedidoID" name="pedidoID" value="" type="hidden" />
        <input id="idclientevendedor" name="idclientevendedor" value="<?php echo e(auth()->user()->id); ?>" type="hidden" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="card card-widget widget-user-2 shadow">
                    ...
                    <div class="widget-user-header bg-primary">
                        ...
                        src="<?php echo e(url('/assets/dist/img/') . '/' . 'logo-amarela-min.png'); ?>"
                        alt="">
                    </div>
                        <h2 class="widget-user-username">PDV</h2>
                        <h5 class="widget-user-desc"><?php echo e($empresa->emp_rzsoc); ?></h5>
                    </div>
                </div>
                ...
                <div class="form-row" style="display:none">
                    <div class="form-group col-sm-12">
                        ...
                        data-placeholder="Selecione"
                            style="width: 100%;">
                            <option></option>
                            <?php $__currentLoopData = $meioDePagamento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($meio->meio_pag); ?>">
                                <?php echo e($meio->meio_pag_desc); ?>
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        <div class="form-group text-center">
                            <div data-identificacao="<?php echo e($meio->meio_pag); ?>" id="<?php echo e($meio->meio_pag_desc); ?>" data-id="<?php echo e($meio->meio_pag_desc); ?>"
                                class="payment-box <?php if($meio->meio_pag == "DN"): ?> payment-box-active <?php endif; ?>">
                                <span class="payment-box-icon"><img src="<?php echo e(asset('assets/dist/img/payment/'). '/' . $meio->meio_pag_icon); ?>"/></span>
                                <div class="payment-box-content">
                                    <span><?php echo e($meio->meio_pag_desc); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="<?php echo e(asset('assets/dist/js/pages/venda/pdv/updatevenda.js')); ?>"></script>
...
<!--script src="<?php echo e(asset('assets/plugins/jquery-print/jQuery.print.min.js')); ?>"></script-->
...
<?php echo $__env->make('layouts.app-master-pdv', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Marcio Bomfim\Desktop\novo\system\multban\resources\views/Multban/venda/pdv/index.blade.php ENDPATH**/ ?>