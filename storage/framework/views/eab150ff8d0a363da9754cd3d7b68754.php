<?php $__env->startSection('page.title', 'Sistema MultMais'); ?>
...
<link rel="stylesheet" href="<?php echo e(asset('assets/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css')); ?>">
<?php $__env->stopPush(); ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control select2" name="fornec_bd" id="fornec_bd"
                                ...
                                <option value=""></option>
                                <?php $__currentLoopData = $tbdmFornecedor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $fornec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <option value="<?php echo e($fornec->fornec); ?>"><?php echo e($fornec->fornec_desc); ?></option>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select id="api_grupo" name="api_grupo" class="form-control select2"
                                ...
                                data-allow-clear="true">
                                <option></option>
                                <?php $__currentLoopData = $tbdmApiGrupo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($grupo->api_grupo); ?>"><?php echo e($grupo->api_grupo_desc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select id="api_subgrp" name="api_subgrp" class="form-control select2"
                                ...
                                data-allow-clear="true">
                                <option></option>
                                <?php $__currentLoopData = $tbdmApiSubGrupo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subGrupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($subGrupo->api_subgrp); ?>"><?php echo e($subGrupo->api_subgrp_desc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control select2" name="tp_plano_pesquisa" data-allow-clear="true"
                                ...
                                <option value="<?php echo e($tpplano->tp_plano); ?>"><?php echo e($tpplano->tp_plano_desc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select id="canal_id_filtro" name="canal_id_filtro"
                                ...
                                <option></option>
                                <?php $__currentLoopData = $tbDmCanalCm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $canal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($canal->canal_id); ?>"><?php echo e($canal->canal_desc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select id="msg_categ_filtro" name="msg_categ_filtro"
                                ...
                                style="width: 100%;" aria-hidden="true">
                                <option></option>
                                <?php $__currentLoopData = $tbDmMsgCateg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $categ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($categ->msg_categ); ?>"><?php echo e($categ->msg_categ_desc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select id="tabela_bdm" name="tabela_bdm"
                                ...
                                <?php if(Str::contains($table->Tables_in_db_sys_client, "tbdm") &&
                                ...
                                <option value="<?php echo e($table->Tables_in_db_sys_client); ?>"><?php echo e($table->Tables_in_db_sys_client); ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control select2" data-allow-clear="true" name="emp_destvlr"
                                ...
                                <option value="<?php echo e($dest->destvlr); ?>"><?php echo e($dest->destvlr); ?> -
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control select2" name="emp_tpbolet" data-allow-clear="true"
                                ...
                                <option value="<?php echo e($tpbolet->emp_tpbolet); ?>"><?php echo e($tpbolet->tpbolet_desc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control select2" data-allow-clear="true" name="emp_adqrnt"
                                ...
                                <option value="<?php echo e($tpadqrnt->emp_adqrnt); ?>"><?php echo e($tpadqrnt->adqrnt_desc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="emp_tab_name" name="emp_tab_name" class="form-control select2"
                            ...
                            <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!Str::contains($table->Tables_in_db_sys_client, "tbsy")): ?>
                            <option value="<?php echo e($table->Tables_in_db_sys_client); ?>"><?php echo e($table->Tables_in_db_sys_client); ?>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select id="bc_fornec" name="bc_fornec" class="form-control select2"
                            ...
                            <?php $__currentLoopData = $tbdmFornecedor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $fornecedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($fornecedor->fornec); ?>"><?php echo e($fornecedor->fornec_desc); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="api_subgrp_api" name="api_subgrp_api" class="form-control select2"
                                ...
                                <option></option>
                                <?php $__currentLoopData = $tbdmApiSubGrupo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($grupo->api_subgrp); ?>"><?php echo e($grupo->api_subgrp_desc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
<script src="<?php echo e(asset('assets/dist/js/pages/sistema-multmais/gridsistema-multmais.js')); ?>"></script>
