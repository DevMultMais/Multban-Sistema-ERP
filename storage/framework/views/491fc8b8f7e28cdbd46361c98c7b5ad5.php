...
<link href="<?php echo e(asset('assets/plugins/summernote/summernote-bs4.min.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<section class="content">
    ...
    <form class="form-horizontal" id="formPrincipal" role="form" method="POST"
        action="<?php echo e(route('cliente.update', $cliente->cliente_id)); ?>">
        <?php echo method_field('PATCH'); ?>
        <?php else: ?>

        <form class="form-horizontal" id="formPrincipal" role="form" method="POST"
            action="<?php echo e(route('cliente.store')); ?>">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control select2" id="cliente_tipo" name="cliente_tipo"
                                                ...
                                                <option value="<?php echo e($tipo->cliente_tipo); ?>" <?php echo e($cliente->cliente_tipo ==
                                                    $tipo->cliente_tipo ? 'selected': ''); ?>><?php echo e($tipo->cliente_tipo_desc); ?>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control select2" id="cliente_sts" name="cliente_sts"
                                                ...
                                                <option value="<?php echo e($sta->cliente_sts); ?>" <?php echo e($cliente->cliente_sts ==
                                                    $sta->cliente_sts ? 'selected': ''); ?>><?php echo e($sta->cliente_sts_desc); ?>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="cliente_doc" name="cliente_doc"
                                                    ...
                                                    value="<?php echo e($cliente->cliente_doc); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input autocomplete="off" class="form-control" placeholder="Digite o nome"
                                                ...
                                                value="<?php echo e($cliente->cliente_nome); ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input autocomplete="off" class="form-control"
                                                ...
                                                type="text" id="cliente_nm_alt" value="<?php echo e($cliente->cliente_nm_alt); ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input autocomplete="off" class="form-control"
                                                ...
                                                type="text" id="cliente_nm_card" value="<?php echo e($cliente->cliente_nm_card); ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input autocomplete="off" type="email" class="form-control"
                                                    ...
                                                    value="<?php echo e($cliente->cliente_email); ?>" placeholder="Digite o E-mail">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control cell_with_ddd"
                                                id="cliente_cel" name="cliente_cel" value="<?php echo e($cliente->cliente_cel); ?>"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control phone_with_ddd"
                                                ...
                                                value="<?php echo e($cliente->cliente_telfixo); ?>" placeholder="Digite o Telefone">
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input autocomplete="off" class="form-control money"
                                                    ...
                                                    type="text" id="cliente_rendam" value="<?php echo e($cliente->cliente_rendam); ?>"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input autocomplete="off" class="form-control"
                                                ...
                                                type="number" id="cliente_dt_fech" value="<?php echo e($cliente->cliente_dt_fech); ?>"
                                                required>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control cell_with_ddd"
                                                value="<?php echo e($cliente->cliente_cel_s); ?>" id="cliente_cel_s"
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control money"
                                                    value="<?php echo e($cliente->cliente_rdam_s); ?>" id="cliente_rdam_s"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo e($cliente->cliente_email_s); ?>" id="cliente_email_s"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="input-group">
                                                <input autocomplete="off" type="text" autofocus="autofocus"
                                                    ...
                                                    value="<?php echo e($cliente->cliente_cep); ?>" placeholder="CEP">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input autocomplete="off" class="form-control" placeholder="Endereço"
                                                value="<?php echo e($cliente->cliente_end); ?>" name="cliente_end" type="text"
                                                id="cliente_end">
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input autocomplete="off" class="form-control" placeholder="Número"
                                                value="<?php echo e($cliente->cliente_endnum); ?>" name="cliente_endnum" type="text"
                                                id="cliente_endnum">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input autocomplete="off" class="form-control" placeholder="Complemento"
                                                value="<?php echo e($cliente->cliente_endcmp); ?>" name="cliente_endcmp" type="text"
                                                id="cliente_endcmp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input autocomplete="off" class="form-control" placeholder="Bairro"
                                                value="<?php echo e($cliente->cliente_endbair); ?>" name="cliente_endbair" type="text"
                                                id="cliente_endbair">
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select id="cliente_endcid" name="cliente_endcid"
                                                ...
                                                <option value="<?php echo e($cliente->cidade->cidade); ?>">
                                                    <?php echo e($cliente->cidade->cidade_desc); ?></option>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select id="cliente_endest" name="cliente_endest"
                                                ...
                                                <option value="<?php echo e($cliente->estado->estado); ?>">
                                                    <?php echo e($cliente->estado->estado); ?> - <?php echo e($cliente->estado->estado_desc); ?>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select id="cliente_endpais" name="cliente_endpais"
                                                ...
                                                aria-hidden="true">
                                                <?php if($cliente->pais): ?>
                                                <option value="<?php echo e($cliente->pais->pais); ?>"><?php echo e($cliente->pais->pais); ?> -
                                                    <?php echo e($cliente->pais->pais_desc); ?></option>
                                                <?php else: ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo e($cliente->cliente_cep_s); ?>"
                                                id="cliente_cep_s" name="cliente_cep_s" disabled>
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="cliente_end_s">Endereço:</label>
                                            <input type="text" class="form-control" value="<?php echo e($cliente->cliente_end_s); ?>"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo e($cliente->cliente_endnum_s); ?>" id="cliente_endnum_s"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo e($cliente->cliente_endcmp_s); ?>" id="cliente_endcmp_s"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo e($cliente->cliente_endbair_s); ?>" id="cliente_endbair_s"
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo e($cliente->cliente_endcid_s); ?>" id="cliente_endcid_s"
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo e($cliente->cliente_endest_s); ?>" id="cliente_endest_s"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo e($cliente->cliente_endpais_s); ?>" id="cliente_endpais_s"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="texto_rec" class="form-control summernote" rows="8">
                                            <div style="display: flex; align-items: flex-start;">
                                                <img src="<?php echo e(asset('assets/dist/img/logo-amarela-min.png')); ?>" alt="Logo" style="height: 50px; margin-right: 15px;">
                                                <div>
                        ...
                        <div class="tab-pane fade" id="tabs-atendimento" role="tabpanel"
                            ...
                            <div class="card"
                                ...
                                <div class="card-header bg-success text-white d-flex align-items-center">
                                    <img src="<?php echo e(asset('assets/dist/img/user-avatar.png')); ?>" alt="Avatar"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formCriarCartao">
                <?php echo method_field('POST'); ?>
                <?php echo csrf_field(); ?>
                <input type="hidden" id="cliente_id" name="cliente_id" value="<?php echo e($cliente->cliente_id); ?>" />
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%;" data-placeholder="Selecione o Tipo" id="card_tp" name="card_tp">
                            <option></option>
                            <?php $__currentLoopData = $cardTipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($card->card_tp); ?>"><?php echo e($card->card_tp_desc); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%;" data-placeholder="Selecione a Modalidade" id="card_mod" name="card_mod">
                            <option></option>
                            <?php $__currentLoopData = $cardMod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($card->card_mod); ?>"><?php echo e($card->card_mod_desc); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%;" data-placeholder="Selecione a Categoria" id="card_categ" name="card_categ">
                            <option></option>
                            <?php $__currentLoopData = $cardCateg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($card->card_categ); ?>"><?php echo e($card->card_categ_desc); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if ("<?php echo e($cliente->cliente_sts); ?>" == "EX" ) {
            $("#btnInativar").text("Ativar");
            $("#btnInativar").prepend('<i class="fa fa-check"></i> ');
            $("#btnExcluir").prop('disabled', true);


        } else if ("<?php echo e($cliente->cliente_sts); ?>" == "AT") {
    ...
    function printCorpoReceita() {
        ...
        janela.document.write('<link rel="stylesheet" href="<?php echo e(asset('assets/plugins/summernote/summernote-bs4.min.css')); ?>">');
        janela.document.write('<link rel="stylesheet" href="<?php echo e(asset('assets/plugins/bootstrap/css/bootstrap.min.css')); ?>">');
...
<script src="<?php echo e(asset('assets/plugins/jquery-validation/additional-methods.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/dist/js/pages/cliente/cliente.js')); ?>"></script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Marcio Bomfim\Desktop\novo\system\multban\resources\views/Multban/cliente/edit.blade.php ENDPATH**/ ?>